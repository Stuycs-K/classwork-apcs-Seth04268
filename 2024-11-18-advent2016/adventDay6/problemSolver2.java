...
public static int minindexOfArray(int[] data) {
int minValue = 10000000;
for (int o = 0; o < data.length; o++) {
if (minValue > data[o] && data[o] > 0) {
minValue = data[o];
}
}
for (int o = 0; o < data.length; o++) {
...
returnString += alphabet[minindexOfArray(alphabetCount)];
...
System.out.println(minindexOfArray(arrayTest));
